...
//               <div
//                 key={product.name}
//                 className="border rounded-lg p-4 mb-4 flex gap-4 bg-white shadow-sm"
//               >
//                 <img
//                   src={product.image}
//                   alt={product.name}
...
//           <button className="w-full bg-[#728F41] hover:bg-[#5f7220] text-white font-bold py-2 mt-6 rounded-lg">
//             PLACE ORDER
//           </button>
//         </div>
//       </div>
...
//             className="w-full bg-[#728F41] hover:bg-[#5f7220] text-white font-bold py-2 mt-6 rounded-lg"
//           >
//             PLACE ORDER
//           </button>
//         </div>
